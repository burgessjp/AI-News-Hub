...
const val READER_SENTINEL = "#aihot-reader"

/** 阅读页内参与翻译的文本块选择器(抽取与写回必须用同一选择器,保证下标对齐)。 */
private const val BLOCK_SELECTOR =
    "#aihot-reader h1,#aihot-reader h2,#aihot-reader h3,#aihot-reader h4," +
        "#aihot-reader p,#aihot-reader li,#aihot-reader blockquote,#aihot-reader figcaption"
...
#aihot-reader { max-width:680px; margin:0 auto; }
#aihot-reader h1 { font-size:1.45em; line-height:1.4; }
#aihot-reader h2,#aihot-reader h3,#aihot-reader h4 { line-height:1.4; }
#aihot-reader .byline { color:var(--muted); font-size:.85em; margin:-0.6em 0 1.6em; }
#aihot-reader img,#aihot-reader video { max-width:100%; height:auto; border-radius:8px; }
#aihot-reader a { color:var(--accent); text-decoration:none; }
#aihot-reader pre { overflow-x:auto; padding:12px 14px; background:var(--code-bg);
                    border-radius:10px; font-size:.88em; }
#aihot-reader code { font-family:ui-monospace,Menlo,monospace; }
#aihot-reader blockquote { margin:1em 0; padding-left:1em;
                           border-left:3px solid var(--line); color:var(--muted); }
</style>
</head>
<body>
<main id="aihot-reader">
 ...
 *
 * 跳过策略:空白块、仓库判定的过短内容([com.example.aihot.data.ShortContentException]
