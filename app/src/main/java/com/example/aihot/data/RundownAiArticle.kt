 ...
 *
 * 双模式源:实时([com.example.aihot.data.RundownAiRepository],jsoup 直抓首页 HTML)
 * 与归档([com.example.aihot.data.source.RundownAiArchiveRepository],读 gitcode 快照)
 * 都支持,由用户设置的 [com.example.aihot.data.source.SourceMode] 决定走哪个。
 *
