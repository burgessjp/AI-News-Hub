...
| **Trends** | Cross-source keyword leaderboard computed from the last 14 days of snapshots (pure statistics, no AI): window hit counts, a mini trend line, and up/down markers; tap a keyword to expand its representative articles. |
